...
name=input("Please input the name of file:")
k=int(input("Please input the batch size:"))
numruns=int(input("Please input the number of runs:"))
loss, time = mysgdsvm(name, k, numruns)
